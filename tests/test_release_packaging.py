...
def test_release_packaging_creates_the_four_root_layouts_and_sorted_checksums(
    ...
    assert [path.name for path in artifacts] == [
        "td-agent-cli-v0.4.0-windows-x86_64.zip",
        "td-agent-component-v0.4.0-td2025.32050.zip",
        "td-daemon-v0.4.0-windows-x86_64.zip",
        "td-v0.4.0-windows-x86_64.zip",
    ]
    expected_entries = {
    ...
    assert "0.4.0" in (output / "install.ps1").read_text(encoding="utf-8")
